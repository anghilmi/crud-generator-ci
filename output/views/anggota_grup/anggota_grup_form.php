...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Anggota_grup <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="varchar">Verif Bos <?php echo form_error('verif_bos') ?></label>
            <input type="text" class="form-control" name="verif_bos" id="verif_bos" placeholder="Verif Bos" value="<?php echo $verif_bos; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('anggota_grup') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>