...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $barang->id_grup ?></td>
			<td><?php echo $barang->id_kategori ?></td>
			<td><?php echo $barang->id_tenant ?></td>
			<td><?php echo $barang->nm_barang ?></td>
			<td><?php echo $barang->user_last_edit ?></td>
			<td><?php echo $barang->foto1 ?></td>
			<td><?php echo $barang->link_toko_ol ?></td>
			<td><?php echo $barang->visibilitas ?></td>
