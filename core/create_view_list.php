...
<a href=\"\" data-toggle=\"modal\" data-target=\"#hapus<?php echo $".$c_url."->".$pk."?> \">
  Hapus
</a>

<!-- Modal -->
<div class=\"modal fade\" id=\"hapus<?php echo $".$c_url."->".$pk."?> \" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"hapusLabel\" aria-hidden=\"true\">
